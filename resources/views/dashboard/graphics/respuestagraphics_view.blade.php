...
function humedad_ambiente_diaria ($chipinfo_sector,$ano,$mes,$dia) {
 ...
 $resultado=pg_query("SELECT extract(epoch FROM fechainfo_sector), sen_h_aminfo_sector FROM info_sectores WHERE date_part('year',fechainfo_sector) = ".$ano." AND date_part('month',fechainfo_sector) = ".$mes." AND date_part('day',fechainfo_sector) = ".$dia." AND chipinfo_sector = '$chipinfo_sector'");
...
<script>
    ...
    title: {
        text: 'Humedad Ambiente del dia:'
    },

    subtitle: {
        text: 'Gráfico Humedad Ambiente'
    },
    ...
    series: [{
        name: 'Humedad Ambiente',
                data: [<?php
                    ...
                    humedad_ambiente_diaria($chipinfo_sector, $ano , $mes, $dia);
                ?>]
    }],
